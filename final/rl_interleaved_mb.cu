...
__device__ void store_full(float *s_mem, float *g_mem, int tile_x, int tile_y, int N, int M, int shared_size_single_matrix)
{
...
{
    FILE *fptr;
    fptr = fopen("dataset/dim2_256matrices.txt", "r");
